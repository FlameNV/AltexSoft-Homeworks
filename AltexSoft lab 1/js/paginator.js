...
function paginator(config) {
  ...
  if (typeof config.box_mode == "function") {
    ...
    page_box.classList.add("skout-glossary-buttons");
    page_box.style.margin = "0";
    ...
    right.classList.add("skout-glossary-slider-next-btn");
    right.style.color = "#22BF95";
    ...
    left.classList.add("skout-glossary-slider-prev-btn");
    left.style.color = "#22BF95";
